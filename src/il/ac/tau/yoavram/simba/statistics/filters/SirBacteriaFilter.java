...
public class SirBacteriaFilter implements Filter<Bacteria> {

	@Override
	public boolean filter(Bacteria filtrate) {
		return (filtrate instanceof SexyBacteria
				&& ((SexyBacteria) filtrate).isSir()) || (filtrate instanceof ModifierBacteria
				&& ((ModifierBacteria) filtrate).isSir());
	}
